...
const rootClass = (a) =>
	'bw-stat' +
	(a.alignment === 'left' ? ' is-align-left' : ' is-align-center');
	...
	return el(
		...
		el(
			...
			el(
				PanelBody,
				{
					title: __('Stat Counter', 'blockwright-blocks'),
					initialOpen: true,
				},
				el(TextControl, {
					label: __('Prefix', 'blockwright-blocks'),
					value: a.prefix,
					onChange: (v) => set({ prefix: v }),
					placeholder: __('e.g. $', 'blockwright-blocks'),
					__nextHasNoMarginBottom: true,
				}),
				el(TextControl, {
					label: __('Value', 'blockwright-blocks'),
					value: a.value,
					onChange: (v) => set({ value: v }),
					__nextHasNoMarginBottom: true,
				}),
				el(TextControl, {
					label: __('Suffix', 'blockwright-blocks'),
					value: a.suffix,
					onChange: (v) => set({ suffix: v }),
					placeholder: __('e.g. + or %', 'blockwright-blocks'),
					__nextHasNoMarginBottom: true,
				}),
				el(ToggleControl, {
					label: __(
		...
		el(
			...
			el(RichText, {
				...
				placeholder: __('What this number means', 'blockwright-blocks'),
			})
		)
	);
}
